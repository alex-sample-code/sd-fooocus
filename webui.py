...
def invoke_claude(chinese_prompt):
    prompt = f"Translate the following prompt/requirements and rephrase it to be a clear, accurate and concise Stable Diffusion prompt to describe the image in English based on your understanding. Put general style specific description at the beginning and end of the prompt. Don't output any preamble, directly generate the result.\n<Chinese Prompt>\n{chinese_prompt}\n</Chinese Prompt>"
    body = {
...
with shared.gradio_root:
    ...
    with gr.Row():
        with gr.Column(scale=2):
            ...
            with gr.Row(elem_classes='type_row'):
                with gr.Column(scale=17):
                    chinese_prompt = gr.Textbox(show_label=False, placeholder="输入提示词", elem_id='pre_prompt',
                                        container=False, autofocus=True, elem_classes='type_row', lines=1024)
                with gr.Column(scale=3, min_width=0):
                    translate_button = gr.Button(label="Claude 3", value="Claude 3", elem_classes='type_row', elem_id='translate_button', visible=True)
        ...
        translate_button.click(invoke_claude, inputs=[chinese_prompt], outputs=[prompt])
